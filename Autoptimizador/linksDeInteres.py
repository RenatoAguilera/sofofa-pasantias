...
#https://www.cursosgis.com/medir-distancias-en-un-mapa-con-python-y-las-librerias-folium-y-geopy/
#https://geoinnova.org/blog-territorio/analisis-redes-de-transporte-phyton-osmnx-networkx/
#https://tesel.mx/calcular-rutas-con-distancias-y-tiempos-entre-puntos-con-google-sheets-8362/
#https://developer.mapquest.com/documentation/directions-api/route/get

#https://www.bbva.es/finanzas-vistazo/ef/finanzas-personales/como-se-puede-calcular-el-consumo-de-combustible-cada-100-kilometros.html
...
#https://calculatodo.com/calcular-gasto-gasolina-viaje
